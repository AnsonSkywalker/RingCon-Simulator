// AIGC note: genuine Joy-Con HID report map, extracted from UARTSwitchCon main.c
// (which credits NathanReeves/BlueCubeMod + wchill/SwitchInputEmulator). Vendor-defined
// usage page 0xFF01; input IDs 0x21/0x30/0x31/0x32/0x33/0x3F; output IDs 0x01/0x10/0x11/0x12.
#pragma once
#include <stdint.h>
#include <stddef.h>

static const uint8_t kJoyConReportMap[] = {
...
static const size_t kJoyConReportMapLen = sizeof(kJoyConReportMap);
